    ...
    def _run(self, output: TaskOutput) -> str:
        ...
        try:
            ...
            file_writer_tool._run(
                filename="code_struct_out.json", content=response, directory=directory, overwrite="True"
            )
            return response
