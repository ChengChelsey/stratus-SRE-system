...
try:
    ...
    PROVIDER_AGENTS = ""
    print("Unable to find environment variable - PROVIDER_AGENTS.")
    raise
...
try:
    ...
    MODEL_AGENTS = ""
    print("Unable to find environment variable - MODEL_AGENTS.")
    raise
...
try:
    ...
    URL_AGENTS = ""
    print("Unable to find environment variable - URL_AGENTS.")
    raise
...
try:
    ...
    THINKING_AGENTS = ""
    print(f"Unable to find environment variable - THINKING_AGENTS. Setting to {THINKING_AGENTS}.")
...
try:
    ...
    print(f"Unable to find environment variable - THINKING_BUDGET_AGENTS. Setting to {THINKING_BUDGET_AGENTS}.")
...
try:
    ...
    MAX_TOKENS_AGENTS = 16000
    print(f"Unable to find environment variable - MAX_TOKENS_AGENTS. Setting to {MAX_TOKENS_AGENTS}.")
...
if PROVIDER_AGENTS == "watsonx" or PROVIDER_TOOLS == "watsonx":
    try:
        ...
        print("To use WatsonX you must provide the WX_PROJECT_ID environment variable.")
        raise
